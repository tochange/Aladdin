	...
	private void setBadgeView(final Context context, final int[] wh) {
		...
		badge.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				Bitmap b = Utils.getBitmapFromView(child);
...
//				Utils.showHardwareInfoLog(mContext);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			yInScreen = LauncherActivity.IS_TABLTE ? event.getRawY() : event
					.getRawY() - Utils.getStatusBarHeight(mContext);
			updateViewPosition();
			break;
