...
public static FloatWindowService mFloatWindowService;
...
//		log.e("");
		FloatWindowManager.removeCustomWindow(getApplicationContext());
		super.onDestroy();
		timer.cancel();
		timer = null;
	}
		...
		public void run() {
			...
			if (isHome() && !FloatWindowManager.isWindowShowing()) {
				handler.post(new Runnable() {
					@Override
					public void run() {
						FloatWindowManager.createCustomWindow(getApplicationContext());
					}
				});
			}
